...
Command: npx gltfjsx@6.2.15 .\bruno-isaac-truck.glb 
*/

import React, { useRef, useFrame } from 'react'
import { useGLTF } from '@react-three/drei'
import { RigidBody, useRevoluteJoint, useFixedJoint, CylinderCollider } from "@react-three/rapier"

export function BrunoIsaac(props) {
  const chassesRef = useRef();
  const tireFL1 = useRef();
  const tireFR2 = useRef();
  const tireRR3 = useRef();
  const tireRL4 = useRef();
  const axelFL1 = useRef();
  const axelFR2 = useRef();
  const axelRR3 = useRef();
  const axelRL4 = useRef();

  const { nodes, materials } = useGLTF('/bruno-isaac-truck.glb')
  return (
    <group {...props} dispose={null}>
      <RigidBody ref={chassesRef} colliders="hull">
      ...
      <RigidBody ref={tireFL1} colliders={false}>
      ...
      <RigidBody ref={axelFL1} colliders='cuboid'>
